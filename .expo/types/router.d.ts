...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/` | `/(tabs)` | `/(tabs)/tttttt.png` | `/tttttt.png` | `/(tabs)/two` | `/two` | `/(tabs)/upload` | `/upload` | `/AuthScreen` | `/TabLayout` | `/modal` | `/navigationTypes` | `/(tabs)/PathwayPage` | `/PathwayPage`;
  // prettier-ignore
